<template>
  <section>
    ...
    <!--编辑界面-->
    <el-dialog title="编辑艺术品信息" v-model="editFormVisible" :close-on-click-modal="false">
...
<script>
  ...
  import {getUserListPage, removeUser, batchRemoveUser, editUser, addUser, addArtwork} from '../../api/api';
